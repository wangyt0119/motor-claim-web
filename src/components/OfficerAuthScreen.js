...
function OfficerAuthScreen({ onAuthenticated }) {
  ...
  const handleLogin = async (values) => {
    ...
    try {
      ...
      if (![USER_ROLE.Officer, USER_ROLE.Admin].includes(role)) {
        throw new Error('Only officer or admin accounts can access this portal.');
      }
      ...
      <div className="auth-screen__content" style={{ gridTemplateColumns: '1fr minmax(360px, 500px)' }}>
        ...
        <Card className="auth-card" bordered={false}>
          ...
          >
            ...
            <Text type="secondary">Sign in with your authorized officer or admin account.</Text>
